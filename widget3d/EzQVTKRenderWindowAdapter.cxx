...
class EzQVTKRenderWindowAdapter::QVTKInternals
{
...
public:
  EzQVTKRenderWindowAdapter* Self;
  EzQVTKInteractorAdapter InteractorAdapter;
  ...
  QVTKInternals(QOpenGLContext* cntxt, vtkGenericOpenGLRenderWindow* renWin,
    QObject* widgetOrWindow, EzQVTKRenderWindowAdapter* self)
...
//------------------------------------------------------------------------------
void EzQVTKRenderWindowAdapter::QVTKInternals::renderWindowEventHandler(
...
//------------------------------------------------------------------------------
void EzQVTKRenderWindowAdapter::QVTKInternals::updateDPI() const
{
...
//------------------------------------------------------------------------------
EzQVTKRenderWindowAdapter::EzQVTKRenderWindowAdapter(
  QOpenGLContext* cntxt, vtkGenericOpenGLRenderWindow* renWin, QWidget* widget)
  : EzQVTKRenderWindowAdapter(cntxt, renWin, static_cast<QObject*>(widget))
{
}
...
EzQVTKRenderWindowAdapter::EzQVTKRenderWindowAdapter(
  ...
  : EzQVTKRenderWindowAdapter(cntxt, renWin, static_cast<QObject*>(window))
{
}
...
EzQVTKRenderWindowAdapter::EzQVTKRenderWindowAdapter(
  ...
  , Internals(new EzQVTKRenderWindowAdapter::QVTKInternals(cntxt, renWin, widgetOrWindow, this))
...
//------------------------------------------------------------------------------
void EzQVTKRenderWindowAdapter::contextAboutToBeDestroyed()
{
  this->Internals.reset(nullptr);
}

//------------------------------------------------------------------------------
void EzQVTKRenderWindowAdapter::paint()
{
  if (this->Internals)
  {
...
//------------------------------------------------------------------------------
void EzQVTKRenderWindowAdapter::resize(int width, int height)
{
  if (this->Internals)
  {
...
//------------------------------------------------------------------------------
bool EzQVTKRenderWindowAdapter::blit(
...
//------------------------------------------------------------------------------
bool EzQVTKRenderWindowAdapter::handleEvent(QEvent* evt)
{
...
//------------------------------------------------------------------------------
void EzQVTKRenderWindowAdapter::setEnableHiDPI(bool value)
{
  if (this->Internals)
  {
...
//------------------------------------------------------------------------------
void EzQVTKRenderWindowAdapter::setUnscaledDPI(int unscaledDPI)
{
  if (this->Internals)
  {
...
//-----------------------------------------------------------------------------
void EzQVTKRenderWindowAdapter::setCustomDevicePixelRatio(double sf)
{
  if (this->Internals)
  {
...
//------------------------------------------------------------------------------
QSurfaceFormat EzQVTKRenderWindowAdapter::defaultFormat(bool stereo_capable)
{
  QSurfaceFormat fmt;
