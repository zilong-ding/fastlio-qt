...
#include "EzQVTKInteractor.h"        // needed for EzQVTKInteractor
#include "vtkNew.h"                // needed for vtkNew
#include "vtkSmartPointer.h"       // needed for vtkSmartPointer

VTK_ABI_NAMESPACE_BEGIN
class EzQVTKInteractor;
class EzQVTKInteractorAdapter;
class EzQVTKRenderWindowAdapter;
class vtkGenericOpenGLRenderWindow;

class EzQVTKOpenGLNativeWidget : public QOpenGLWidget
{
  Q_OBJECT
  typedef QOpenGLWidget Superclass;

public:
  EzQVTKOpenGLNativeWidget(QWidget* parent = nullptr, Qt::WindowFlags f = Qt::WindowFlags());
  EzQVTKOpenGLNativeWidget(vtkGenericOpenGLRenderWindow* window, QWidget* parent = nullptr,
    Qt::WindowFlags f = Qt::WindowFlags());
  ~EzQVTKOpenGLNativeWidget() override;
  ...
  /**
   * Get the EzQVTKInteractor that was either created by default or set by the user.
   */
  EzQVTKInteractor* interactor() const;
...
protected: // NOLINT(readability-redundant-access-specifiers)
  ...
  QScopedPointer<EzQVTKRenderWindowAdapter> RenderWindowAdapter;

private:
  Q_DISABLE_COPY(EzQVTKOpenGLNativeWidget);
